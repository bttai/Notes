...
def csrf_token(target):
    ...
    # <input type="hidden" name="user_token" value="e8e0d07b1de6e796129662298dc73493">
...
def blink(cookies):
    ...
    url = dvwa + "/vulnerabilities/sqli/session-input.php"
    url_redirect = dvwa + '/vulnerabilities/sqli/'
