└─$ sudo nmap -A -p- 10.0.1.13
Starting Nmap 7.91 ( https://nmap.org ) at 2021-09-09 15:32 CEST
...
SYN Stealth Scan Timing: About 42.37% done; ETC: 15:34 (0:01:15 remaining)
Stats: 0:02:19 elapsed; 0 hosts completed (1 up), 1 undergoing Script Scan
NSE Timing: About 99.91% done; ETC: 15:34 (0:00:00 remaining)
...
|   Some Capabilities: ConnectWithDatabase, SupportsLoadDataLocal, LongPassword, Support41Auth, ODBCClient, IgnoreSpaceBeforeParenthesis, SupportsTransactions, IgnoreSigpipes, InteractiveClient, Speaks41ProtocolNew, Speaks41ProtocolOld, SupportsCompression, FoundRows, DontAllowDatabaseTableColumn, LongColumnFlag, SupportsMultipleStatments, SupportsAuthPlugins, SupportsMultipleResults
|   Status: Autocommit
|   Salt: "ZH\x12\x1C>\\x02EY~\x10\x0Fl
| \x06~T>W
...
SF-Port666-TCP:V=7.91%I=7%D=9/9%Time=613A0D50%P=x86_64-pc-linux-gnu%r(NULL
...
MAC Address: 08:00:27:A3:B6:24 (Oracle VirtualBox virtual NIC)
...
|   Domain name: \x00
|   FQDN: red
|_  System time: 2021-09-09T16:34:20+01:00
| smb-security-mode: 
|   account_used: guest
...
Nmap done: 1 IP address (1 host up) scanned in 148.95 seconds
